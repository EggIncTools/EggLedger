...
<p align="center">
  <a href="https://eggledger.egginc.tools/"><img src="EggLedger.Desktop/assets/open-web-app.svg" alt="open web app"></a>
...
**Web app: [eggledger.egginc.tools](https://eggledger.egginc.tools/)** - nothing to install. Discord login is used only for identification, and optionally to sync settings.
